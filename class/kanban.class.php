...
class Kanban extends SaturneObject
{
	 ...
	 */
	public $element = 'digikanban_kanban';
	...
	public $fields = [
		...
		'status'		=> ['type' => 'integer',      'label' => 'Status',           'enabled' => 1, 'position' => 100, 'notnull' => 0, 'visible' => 1],
		'fk_project'    => ['type' => 'integer:Project:projet/class/project.class.php:1', 'label' => 'Project',     'picto' => 'project', 'enabled' => 1, 'position' => 105,  'notnull' => 1, 'visible' => 1, 'showinpwa' => 0, 'index' => 1, 'css' => 'maxwidth500 widthcentpercentminusxx', 'foreignkey' => 'projet.rowid', 'positioncard' => 2],
		'object_type'	=> ['type' => 'varchar(255)', 'label' => 'ObjectType',       'enabled' => 1, 'position' => 110, 'notnull' => 0, 'visible' => 0],
		'object_id'		=> ['type' => 'integer',      'label' => 'ObjectId',         'enabled' => 1, 'position' => 120, 'notnull' => 0, 'visible' => 0],
	 ...
	 */
	public function __construct(DoliDB $db, string $moduleNameLowerCase = 'digikanban', string $objectType = 'digikanban_kanban')
	{
