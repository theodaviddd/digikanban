...
/**
 *  \file       advkanbancard_contact.php
 *  \ingroup    advancedkanban
 *  \brief      Tab for contacts linked to AdvKanbanCard
 */
...
$hookmanager->initHooks(array('advkanbancardcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('AdvKanbanCard')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("AdvKanbanCard"), -1, $object->picto);
